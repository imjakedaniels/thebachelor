...
ggplot() +
  ...
  geom_line(aes(x=Season, y=Rating), color = "dark grey", size = 1.1) +
    geom_line(aes(x = Season, y = mean(Rating)), linetype = 2, color = "Black") + 
  
  geom_point(x = 22, y= mean(bachelor[which(bachelor$Season == 22),]$Rating), size = 2, colour = "blue") +
  geom_point(x = 18, y = mean(bachelor[which(bachelor$Season == 18),]$Rating), size = 2, colour = "red") +
